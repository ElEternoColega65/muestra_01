...
const PlaystationFive = () => {
  const title = "Juegos PS5 - playstation 5 - Compra o haz tu Reserva | page";
  ...
  return (
    <MainContent>
      <Sections>
        <MenuMarginTop />
        <MainTitle>TODO PARA PLAYSTATION 5</MainTitle>
        <SectionVideoGames>
          <SectionContent>
            <TitleContainer>
              <TitleH2>¡YA DISPONIBLE EN PS5!</TitleH2>
            </TitleContainer>
            <SwiperMultiContent>
              <BannerContainer>
                <VideoGamesCarousel
...
export default PlaystationFive;