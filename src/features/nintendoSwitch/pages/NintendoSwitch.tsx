...
const NintendoSwitch = () => {
  const title = "Juego de Nintendo Switch: Compra o haz tu Reserva | page";
  ...
  return (
    <MainContent>
      <Sections>
        <MenuMarginTop />
        <MainTitle>JUEGOS NINTENDO SWITCH</MainTitle>
        <SectionVideoGames>
          <SectionContent>
            <TitleContainer>
              <TitleH2>¡YA DISPONIBLES EN NINTENDO SWITCH!</TitleH2>
            </TitleContainer>
            <SwiperMultiContent>
              <BannerContainer>
                <VideoGamesCarousel
