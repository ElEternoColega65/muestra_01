...
import { useGetNintendoSwitchVideoGamesQuery } from '../../redux/nintendoSwitchApiSlice';
...
const VideoGamesCarousel = ({
  ...
  const { data: videoGames, isLoading, isError } = useGetNintendoSwitchVideoGamesQuery();
  ...
  if (isError || isLoading || !isLoading && !videoGames) return <></>
  ...
  return (
    <>
      ...
      >
        {videoGames.map((data, index: number) =>
