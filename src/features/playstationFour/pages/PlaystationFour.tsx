...
const PlaystationFour = () => {
  const title = "Juegos PS4 - playstation 4 - Compra o haz tu Reserva | page";
  ...
  return (
    <MainContent>
      <Sections>
        <MenuMarginTop />
        <MainTitle>TODO PARA PLAYSTATION 4</MainTitle>
        <SectionVideoGames>
          <SectionContent>
            <TitleContainer>
              <TitleH2>¡YA DISPONIBLE EN PS4!</TitleH2>
            </TitleContainer>
            <SwiperMultiContent>
              <BannerContainer>
                <VideoGamesCarousel
